"""
Django settings for lively_union_40166 project.
...
ROOT_URLCONF = 'lively_union_40166.urls'
...
WSGI_APPLICATION = 'lively_union_40166.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_union_40166 API",
    "DESCRIPTION": "API documentation for lively_union_40166 App",
    "VERSION": "v1",
}
